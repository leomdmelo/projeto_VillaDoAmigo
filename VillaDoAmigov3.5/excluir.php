                ...
                ');
                    if($_POST){
                        ...
                        if(empty($senha) OR empty($csenha)){
                            echo('<script>window.alert("Preencha todos os campos para que a exclusão da sua conta seja feita!");window.location="excluir.php";</script>');
                          }
                        elseif($senha != $csenha){
                            echo('<script>window.alert("As senhas não corespondem!");window.location="excluir.php";</script>');
                        }
                        elseif($senha != $senha_deco){
                            echo('<script>window.alert("Senha errada, tente novamente!");window.location="excluir.php";</script>');
                        }
                        else{
                            $delete = ("delete from usuario where login='$logado';");
                            $query = $mysqli->query($delete);
                            session_destroy();
                            echo('<script>window.alert("Adios amigo :(");window.location="index.php";</script>');
                        }
                    }
                ?>
            </form>
